...
jdbcUsername = dbutils.secrets.get(scope = "demo", key = "dbuser")
jdbcPassword = dbutils.secrets.get(scope = "demo", key = "dbpasswd")

tempDir = "s3a://partner-enablement-redshift/temp"
jdbcUrl = "jdbc:redshift://redshift-awscore.cyyewh0t7hhq.us-west-2.redshift.amazonaws.com:5439/db"
...
obscuredDF = redshift_table.withColumn("ssn", regexp_replace(col("ssn"), "([0-9]{3}-[0-9]{2})", "***-**")).alias("ssn")
