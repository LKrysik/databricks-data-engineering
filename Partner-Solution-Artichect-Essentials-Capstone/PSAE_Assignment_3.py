...
# MAGIC # Partner Solution Architect Essentials - Assignment 3
# MAGIC 
...
def training_run(p_max_depth = 2, p_owner = "default") :
  with mlflow.start_run() as run:
    ...
    # 
    mlflow.log_param("Maximum", p_max_depth)
    # 
    # END OF TO DO
    #
    ...
    #
    mlflow.log_metrics({"Training Data Rows": training_data.count(), "Test Data Rows": test_data.count()})
    # 
    # END OF TO DO
    #
...
df_model_selector = spark.sql("""
  SELECT experiment_id,
         ...
         artifact_uri || '/spark-model' AS model_uri
  FROM vw_client
...
# MAGIC       WHEN prediction = 6 THEN 'DECENDING'
# MAGIC       ELSE 'UNKNOWN'
