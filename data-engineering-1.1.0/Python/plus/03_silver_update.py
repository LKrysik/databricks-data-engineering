...
# TODO
assert updatesDF.schema == spark.read.format("delta").load(silverPath).schema, "Schemas do not match"
...
display(
  spark.read.table("health_tracker_plus_silver").groupby("device_id").count()
)
