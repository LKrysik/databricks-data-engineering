...
assert silver_health_tracker.schema == _parse_datatype_string("device_id INTEGER, heartrate DOUBLE, eventtime TIMESTAMP, name STRING, p_eventdate DATE"), "File not present in Silver Path"
print("Assertion passed.")
