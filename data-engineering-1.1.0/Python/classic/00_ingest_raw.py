...
dbutils.fs.rm("dbfs:/user/hive/warehouse/dbacademy_tomxu.db/deletions", True)
...
# TODO
print(dbutils.fs.head(rawPath + "2021-08-22-16-25-06.txt"))

# COMMAND ----------

# TODO
print(dbutils.fs.head(rawPath + "2021-08-22-16-25-27.txt"))
