...
bronzeAugmentedDF = bronzeDF.withColumn("nest_json", from_json(("value"), json_schema))
...
# TODO
silver_health_tracker = bronzeAugmentedDF.select("value", "nest_json.*")
...
# MAGIC %sql
# MAGIC SELECT * FROM health_tracker_classic_bronze WHERE status="quarantined"
