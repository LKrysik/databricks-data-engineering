...
# MAGIC %sql
# MAGIC SELECT count(*) FROM recordings_raw_temp
...
# MAGIC %sql
# MAGIC SELECT count(*) FROM bronze_unparsed_temp
...
display(dbutils.fs.ls(recordingsParsedCheckpoint))

# COMMAND ----------

dbutils.fs.head(recordingsParsedCheckpoint + "/offsets/1")
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TEMPORARY VIEW PII
# MAGIC USING CSV
# MAGIC OPTIONS(inferSchema="true", header="true", path="dbfs:/mnt/training/healthcare/patient/patient_info.csv")
