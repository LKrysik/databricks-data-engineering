...
spark.readStream.table("loans.gold_loan_stats").createOrReplaceTempView("gold_loan_stats_live")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM gold_loan_stats_live
...
# MAGIC %sql
# MAGIC UPDATE loans.gold_loan_stats SET amount=50000000 WHERE addr_state="PA"
...
# MAGIC %sql
# MAGIC SELECT * FROM gold_loan_stats VERSION AS OF 2
