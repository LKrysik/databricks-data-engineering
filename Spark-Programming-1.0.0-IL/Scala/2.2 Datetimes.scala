...
// MAGIC 
// MAGIC ##### Methods
// MAGIC - Column (<a href="https://spark.apache.org/docs/latest/api/python/pyspark.sql.html?highlight=column#pyspark.sql.Column" target="_blank">Python</a>/<a href="http://spark.apache.org/docs/latest/api/scala/org/apache/spark/sql/Column.html" target="_blank">Scala</a>): `cast`
...
// TODO
val activeUsersDF = datetimeDF.FILL_IN
...
// TODO
val activeDowDF = activeUsersDF.FILL_IN
